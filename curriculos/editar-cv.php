...
<div class="section">
	...
	<form id="editCv" action="edita-cv.php" class="search_form general_form" method="post">
		...
		<input type="hidden" name="idPretensoes" value="<?=$pretensoes->id?>" />
							...
							<select name="cidade" id="cidade">
								<option value="">Selecione uma cidade</option>
									...
									if($cidades)
									{
										...
										{
											if($pessoa->cidade == $cidade->id) $selected = "selected='selected'"; else $selected = "";
	        ...
	        <p>
	            <input id="SalvaCV" type="submit" name="submit" value="Salvar Currículo" />
	        </p>
	</form>
	<!--[if !IE]>end forms<![endif]-->
